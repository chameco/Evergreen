-----EVERGREEN-----
A 2D game engine, writen in Python and C++, that follows the mediator and MVC patterns.
-------------------
---INTRODUCTION----
-------------------
   Since this is fairly complicated, I'm going to write the actual documentation later. Instead,
I have some advice: read client.py before ANYTHING else. It follows the same basic model sas the
...
point it becomes impossible to comprehend it all at once.